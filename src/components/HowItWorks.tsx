...
import { Camera, Copy, Sparkles, Share2 } from 'lucide-react';
            ...
            <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 w-full">
                <div className="text-center mb-16">
                    ...
                    <p className="mt-4 text-lg text-gray-500 max-w-2xl mx-auto">
                        Give your die-cast collection the spotlight it deserves in four simple steps.
                    </p>
                </div>

                <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-12 relative">
                    {/* Connector Line (Desktop only - adjusted for 4 columns) */}
                    <div className="hidden lg:block absolute top-12 left-[12.5%] right-[12.5%] h-0.5 bg-gray-200 -z-10 transform -translate-y-1/2" />
                    ...
                    {/* Step 4 */}
                    <div className="relative flex flex-col items-center text-center group">
                        <div className="w-24 h-24 bg-white border border-gray-200 rounded-2xl flex items-center justify-center mb-6 shadow-sm group-hover:shadow-md group-hover:border-indigo-200 transition-all duration-300">
                            <div className="w-12 h-12 bg-indigo-50 text-indigo-600 rounded-xl flex items-center justify-center">
                                <Share2 className="w-6 h-6" />
                            </div>
                        </div>
                        <h3 className="text-xl font-bold text-gray-900 mb-3">4. Share & Shine</h3>
                        <p className="text-gray-500 leading-relaxed px-4">
                            Share your breathtaking photos on social media to boost views and engagement. Let your masterpieces take center stage!
                        </p>
                    </div>
                </div>
            </div>
